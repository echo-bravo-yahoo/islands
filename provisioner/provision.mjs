...
customize += `--plugin copydir:"from=${resolve(config.islands.srcPath)}|to=${config.islands.destPath}|rsyncopts=-a --exclude-from ${resolve(__dirname, './rsync-exclude.txt')} --owner --group --progress" `
